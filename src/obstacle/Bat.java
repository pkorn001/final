...
public class Bat extends Monster{
	...
	public Bat(Position a, int width, int height, int monsterType, double xSpeed, double ySpeed) {
	...
	public void draw(GraphicsContext g2d) {
		if (isDestroyed()) {
			...
			g2d.drawImage(Resource.Monster5,this.getB().getX(),this.getB().getY(),this.getWidth(),this.getHeight());
		}
	}
	
	@Override
	public boolean collide(Hitbox hitbox) {
		if (hitbox.equals(Assassin.getAttackBox())) {
